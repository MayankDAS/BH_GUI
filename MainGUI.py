...
def connectmdb():
        try:
            mydb = mysql.connector.connect(host="localhost",  user="root",  password="haluha12", database="purchasinglog")
...
def newpurchase():
    ...
    def savepurchase():
        ...
        try:
            ...
            mycursor.execute("INSERT INTO partpaymentpurchase (AmountT, Party_Name, Bill_Number, BIll_Date) VALUES('"+amntTTs+"', '"+party+"','"+bill+"', '"+ date +"')")
    ...
    def querrybill():
        ...
        mycursor = mydb.cursor()
        billqq=E10.get()
        mycursor.execute("SELECT AmountT, Party_Name, Amount_Paid, Balance, BIll_Date FROM partpaymentpurchase WHERE Bill_Number = '"+ billqq +"'")
        ...
        L11 = Label(frquery, text="Balance: ").grid(row=6, column=0)
        L10 = Label(frquery, text=balqr).grid(row=6, column=1)
    ...
    def updatepayment():
        ...
        mainlog = mysql.connector.connect(host="localhost",  user="root",  password="haluha12", database="purchasinglog")
        ...
        baln=float(amntqr)-float(partpays)
        ...
        try:
            ...
            mycursor.execute("INSERT INTO partpaymentpurchase (AmountT, Party_Name, Bill_Number, Part_date, Part_payment, Balance, Amount_Paid, BIll_Date) VALUES('"+amntqr+"', '"+partyqr+"','"+bill+"', '"+partdts+"', '"+partpays+"', '"+ upamntTs +"','"+upamntpds+"','"+dateqr+"' )") 
...
def newproduction():
    ...
    def savecons():
        mainlog = mysql.connector.connect(host="localhost",  user="root",  password="haluha12", database="productionlog")
        mycursor = mainlog.cursor()
        date=E1.get()
        qtyM=E2.get()
        qtyS=E3.get()
...
def newsales():
    ...
    def savesales():
        mydb = mysql.connector.connect(host="localhost",  user="root",  password="haluha12", database="newsales")
        mycursor = mydb.cursor()
        ...
        try:
            ...
            mycursor.execute("INSERT INTO paymentsales (AmountT, Party_Name, Bill_Number, Bill_Date) VALUES('"+amntTTs+"', '"+party+"','"+bill+"', '"+ date +"')")
    ...
    def querrysales():
        ...
        mycursor = mydb.cursor()
        billqq=E10.get()
        mycursor.execute("SELECT AmountT, Party_Name, Amount_Paid, Balance, Bill_Date FROM paymentsales WHERE Bill_Number = '"+ billqq +"'")
        myresult = mycursor.fetchall()
        for x in myresult:
            amntqr = str(x[0])
            partyqr= str(x[1])
        ...
        L11 = Label(frpay, text="Balance: ").grid(row=7, column=0)
        L10 = Label(frpay, text=balqr).grid(row=7, column=1)
    ...
    def uppaysale():
        ...
        mainlog = mysql.connector.connect(host="localhost",  user="root",  password="haluha12", database="newsales")
        mycursor = mainlog.cursor()
        billqq = E10.get()
        partdt = E12.get()
        partpay = E13.get()
        partdts = str(partdt)
        partpays = str(partpay)
        mycursor.execute("SELECT AmountT, Party_Name, Balance, Amount_Paid, Bill_Date, Bill_Number FROM paymentsales WHERE Bill_Number = '"+ billqq +"'")
        myresult = mycursor.fetchall()
        ...
        try:
            ...
            mycursor.execute("INSERT INTO paymentsales (AmountT, Party_Name, Bill_Number, Part_date, Part_Pay, Balance, Amount_Paid, Bill_Date) VALUES('"+amntqr+"', '"+partyqr+"','"+bill+"', '"+partdts+"', '"+partpays+"', '"+ upamntTs +"','"+upamntpds+"','"+dateqr+"' )") 
            messagebox.showinfo("showinfo", "Update Successfull")
        except mysql.connector.Error as err:
            messagebox.showerror("showerror", err)
...
def expend():
    ...
    def saveregx():
        mainlog = mysql.connector.connect(host="localhost",  user="root",  password="haluha12", database="expenditure")
        mycursor = mainlog.cursor()
    ...
    def viewlistbox():
        ...
        if (d1=="Consumption"):
            ...
            if (d2=="Pouches"):
                ...
                mainlog2 = mysql.connector.connect(host="localhost",  user="root",  password="haluha12", database="purchasinglog")
...
#__________________________________________________________VEIW BILLS_________________________________________________________________________________________   
    ...
    def pendingbill():
        ...
        if (qtype=="Purchasing"):
            ...
            mycursor.execute("SELECT DISTINCT BIll_Date, Bill_Number, Party_Name, AmountT, Balance FROM partpaymentpurchase WHERE BIll_Date BETWEEN '"+ dfrom +"' AND '"+ dto +"' AND Balance != '0.00' OR Balance IS NULL ORDER BY BIll_Date DESC ")
            myresult = mycursor.fetchall()
            ...
            Label(frlogs, text="Party").grid(row=0, column=2, sticky=N+W+E)
            Label(frlogs, text="Amount").grid(row=0, column=3, sticky=N+W+E)
            Label(frlogs, text="Balance").grid(row=0, column=4, sticky=N+W+E)
            Label(frlogs, text="Sr. No.").grid(row=0, column=5, sticky=N+W+E)
            ...
            for y in range(rc):
                ...
                Lb=Label(frlogs, text=str(amntm[y])).grid(row=y+1, column=3)
                Lb=Label(frlogs, text=str(bal[y])).grid(row=y+1, column=4)
                LL=Label(frlogs, text=str(y+1)).grid(row=y+1, column=5)
                if (str(amntm[y])=="None"):
                    amntm[y] = 0
                sumamnt = sumamnt + float(str(amntm[y]))
        ...
        if (qtype=="Sales"):
            ...
            mycursor.execute("SELECT DISTINCT Bill_Date, Bill_Number, Party_Name, AmountT FROM paymentsales WHERE Bill_Date BETWEEN '"+ dfrom +"' AND '"+ dto +"' AND Balance != '0.00' OR Balance IS NULL ORDER BY Bill_Date DESC ")
            myresult = mycursor.fetchall()
    ...
    def partybills():
        ...
        if (qtype=="Purchasing"):
            ...
            mycursor.execute("SELECT BIll_Date, Bill_Number, Party_Name, AmountT, Balance, Part_date, Part_payment, Amount_Paid FROM partpaymentpurchase WHERE BIll_Date BETWEEN '"+ dfrom +"' AND '"+ dto +"' AND Party_Name = '"+partyname+"' ORDER BY BIll_Date DESC ")
            myresult = mycursor.fetchall()
            ...
            Lb=Label(frlogs, text="Balance").grid(row=0, column=7, sticky=N+W+E)
            Lb=Label(frlogs, text="Part_Date").grid(row=0, column=5, sticky=N+W+E)
            Lb=Label(frlogs, text="Part_Payment").grid(row=0, column=6, sticky=N+W+E)
            Lb=Label(frlogs, text="Amount_Paid").grid(row=0, column=4, sticky=N+W+E)
            Lb=Label(frlogs, text="Sr. No.").grid(row=0, column=8, sticky=N+W+E)
            ...
            for y in range(rc):
                ...
                Lb=Label(frlogs, text=str(ptdat[y])).grid(row=y+1, column=5)
                Lb=Label(frlogs, text=str(ptpay[y])).grid(row=y+1, column=6)
                Lb=Label(frlogs, text=str(amntpd[y])).grid(row=y+1, column=4)
                LL=Label(frlogs, text=str(y+1)).grid(row=y+1, column=8)
        ...
        if (qtype=="Sales"):
            ...
            mycursor.execute("SELECT Bill_Date, Bill_Number, Party_Name, AmountT, Balance, Part_Date, Part_Pay, Amount_Paid FROM paymentsales WHERE Bill_Date BETWEEN '"+ dfrom +"' AND '"+ dto +"' AND Party_Name = '"+partyname+"' ORDER BY BIll_Date DESC ")
            myresult = mycursor.fetchall()
    ...
    def billpart():
        ...
        if (qtype=="Purchasing"):
            ...
            mycursor.execute("SELECT BIll_Date, Bill_Number, Party_Name, AmountT, Balance, Part_date, Part_payment, Amount_Paid FROM partpaymentpurchase WHERE BIll_Date BETWEEN '"+ dfrom +"' AND '"+ dto +"' AND Bill_Number = '"+billquery+"' ORDER BY BIll_Date DESC ")
            myresult = mycursor.fetchall()
            ...
            LL=Label(frlogs, text="Balance").grid(row=0, column=7, sticky=N+W+E)
            LL=Label(frlogs, text="Part_Date").grid(row=0, column=5, sticky=N+W+E)
            LL=Label(frlogs, text="Part_Payment").grid(row=0, column=6, sticky=N+W+E)
            LL=Label(frlogs, text="Amount_Paid").grid(row=0, column=4, sticky=N+W+E)
            LL=Label(frlogs, text="Sr. No.").grid(row=0, column=8, sticky=N+W+E)
        ...
        if (qtype=="Sales"):
            ...
            mycursor.execute("SELECT Bill_Date, Bill_Number, Party_Name, AmountT, Balance, Part_Date, Part_Pay, Amount_Paid FROM paymentsales WHERE Bill_Date BETWEEN '"+ dfrom +"' AND '"+ dto +"' AND Bill_Number = '"+billquery+"' ORDER BY BIll_Date DESC ")
            myresult = mycursor.fetchall()
...
#__________________________________________________________VEIW LOGS FRAME__________________________________________________________________________________________   
    ...
    frlog = LabelFrame(result, text="View Logs", padx=10, pady=10, height=400, width=400)
    frlog.grid(row=0, column=0, padx=10, pady=10)
    
    frbill = LabelFrame(result, text="View Bills", padx=10, pady=10, height=400, width=400)
...
def analysis():
    ...
    def graphs():
        ...
        salelog = mysql.connector.connect(host="localhost",  user="root",  password="haluha12", database="newsales")
        ...
        purlog = mysql.connector.connect(host="localhost",  user="root",  password="haluha12", database="purchasinglog")
        ...
        explog = mysql.connector.connect(host="localhost",  user="root",  password="haluha12", database="expenditure")
...
frame1 = LabelFrame(root, text="Material Purchasing", padx=20, pady=20, bg="light pink", relief=RIDGE, height=60, width=60)
...
frame2 = LabelFrame(root, text="Consumption and Production", padx=20, pady=20, bg="light blue", relief=RIDGE, height=60, width=60)
...
frame3 = LabelFrame(root, text="Sales", padx=20, pady=20, bg="light green", relief=RIDGE, height=60, width=60)
...
frame4 = LabelFrame(root, text="Expenditure Entry", padx=20, pady=20, bg="light green", relief=RIDGE, height=60, width=60)
...
frame5 = LabelFrame(root, text="Results", padx=20, pady=20, bg="light blue", relief=RIDGE, height=60, width=60)
...
frame6 = LabelFrame(root, text="Analysis", padx=20, pady=20, bg="light pink", relief=RIDGE, height=60, width=60)
